...
import com.example.nabella.moviestation.activity.other.AboutUsActivity;
...
//    private static final String urlProfileImg = "https://lh3.googleusercontent.com/eCtE_G34M9ygdkmOpYvCag1vBARCmZwnVS6rS5t4JLzJ6QgQSBquM0nuTsCpLhYbKljoyS-txg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.imgNavHeaderBg = (ImageView) navHeader.findViewById(R.id.img_header_bg);
        super.imgProfile = (ImageView) navHeader.findViewById(R.id.img_profile);
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText(super.customer.getNama());
        txtWebsite.setText(super.customer.getEmail());
